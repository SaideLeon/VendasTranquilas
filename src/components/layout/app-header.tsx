...
import { Package, ShoppingCart, BarChart3, Wifi, WifiOff, Cloud, Upload, Download, Landmark, HandCoins, BrainCircuit, Shield } from "lucide-react"; // Added HandCoins for Debts, BrainCircuit for Insights
